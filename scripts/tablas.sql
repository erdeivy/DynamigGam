...
--------------------------------------------------------
  ...
  CREATE TABLE "HR"."GAM_REWARDS_STATS" 
   (	"ID_REWARDS_STATS" NUMBER(10,0), 
	...
	"ID_STRATEGY" NUMBER(10,0), 
	"ID_ACTION" NUMBER(10,0), 
	"SHOWN" VARCHAR2(1 CHAR) DEFAULT 'N'
   ) SEGMENT CREATION IMMEDIATE 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
SET DEFINE OFF;
Insert into HR.GAM_ACTIONS (ID_STRATEGY,ID_ACTION,TABLE_NAME,OPERATION,COLUMN_NAME,REPETITIONS,ID_REWARD) values ('3','44','Festividades','DELETE',null,'1','6');
Insert into HR.GAM_ACTIONS (ID_STRATEGY,ID_ACTION,TABLE_NAME,OPERATION,COLUMN_NAME,REPETITIONS,ID_REWARD) values ('2','46','SUELDO','DELETE',null,'3','22');
Insert into HR.GAM_ACTIONS (ID_STRATEGY,ID_ACTION,TABLE_NAME,OPERATION,COLUMN_NAME,REPETITIONS,ID_REWARD) values ('2','47','SUELDO','INSERT',null,'3','23');
...
SET DEFINE OFF;
Insert into HR.GAM_CELL (ROW_KEY,COLUMN_NAME,CELL_VALUE) values ('121','Fecha','1');
Insert into HR.GAM_CELL (ROW_KEY,COLUMN_NAME,CELL_VALUE) values ('121','Lugar','1');
Insert into HR.GAM_CELL (ROW_KEY,COLUMN_NAME,CELL_VALUE) values ('121','Nombre','1');
Insert into HR.GAM_CELL (ROW_KEY,COLUMN_NAME,CELL_VALUE) values ('121','Objetivo','1');
...
Insert into HR.GAM_CELL (ROW_KEY,COLUMN_NAME,CELL_VALUE) values ('122','Fecha','2');
Insert into HR.GAM_CELL (ROW_KEY,COLUMN_NAME,CELL_VALUE) values ('122','Lugar','2');
Insert into HR.GAM_CELL (ROW_KEY,COLUMN_NAME,CELL_VALUE) values ('122','Nombre','2');
Insert into HR.GAM_CELL (ROW_KEY,COLUMN_NAME,CELL_VALUE) values ('122','Objetivo','2');
Insert into HR.GAM_CELL (ROW_KEY,COLUMN_NAME,CELL_VALUE) values ('123','Fecha','3');
Insert into HR.GAM_CELL (ROW_KEY,COLUMN_NAME,CELL_VALUE) values ('123','Lugar',null);
Insert into HR.GAM_CELL (ROW_KEY,COLUMN_NAME,CELL_VALUE) values ('123','Nombre',null);
Insert into HR.GAM_CELL (ROW_KEY,COLUMN_NAME,CELL_VALUE) values ('123','Objetivo',null);
Insert into HR.GAM_CELL (ROW_KEY,COLUMN_NAME,CELL_VALUE) values ('124','Fecha','4');
Insert into HR.GAM_CELL (ROW_KEY,COLUMN_NAME,CELL_VALUE) values ('124','Lugar',null);
Insert into HR.GAM_CELL (ROW_KEY,COLUMN_NAME,CELL_VALUE) values ('124','Nombre',null);
Insert into HR.GAM_CELL (ROW_KEY,COLUMN_NAME,CELL_VALUE) values ('124','Objetivo',null);
Insert into HR.GAM_CELL (ROW_KEY,COLUMN_NAME,CELL_VALUE) values ('125','Fecha','5');
Insert into HR.GAM_CELL (ROW_KEY,COLUMN_NAME,CELL_VALUE) values ('125','Lugar',null);
Insert into HR.GAM_CELL (ROW_KEY,COLUMN_NAME,CELL_VALUE) values ('125','Nombre',null);
Insert into HR.GAM_CELL (ROW_KEY,COLUMN_NAME,CELL_VALUE) values ('125','Objetivo',null);
Insert into HR.GAM_CELL (ROW_KEY,COLUMN_NAME,CELL_VALUE) values ('101','NombreProveedor','Instalaciones eléctricas Juan');
...
Insert into HR.GAM_CELL (ROW_KEY,COLUMN_NAME,CELL_VALUE) values ('44','Nombre','Fiesta de la patronas');
Insert into HR.GAM_CELL (ROW_KEY,COLUMN_NAME,CELL_VALUE) values ('44','Objetivo','Divertirsesss');
Insert into HR.GAM_CELL (ROW_KEY,COLUMN_NAME,CELL_VALUE) values ('141','Fecha',null);
Insert into HR.GAM_CELL (ROW_KEY,COLUMN_NAME,CELL_VALUE) values ('141','Lugar',null);
Insert into HR.GAM_CELL (ROW_KEY,COLUMN_NAME,CELL_VALUE) values ('141','Nombre',null);
Insert into HR.GAM_CELL (ROW_KEY,COLUMN_NAME,CELL_VALUE) values ('141','Objetivo',null);
Insert into HR.GAM_CELL (ROW_KEY,COLUMN_NAME,CELL_VALUE) values ('142','Fecha',null);
Insert into HR.GAM_CELL (ROW_KEY,COLUMN_NAME,CELL_VALUE) values ('142','Lugar',null);
Insert into HR.GAM_CELL (ROW_KEY,COLUMN_NAME,CELL_VALUE) values ('142','Nombre',null);
Insert into HR.GAM_CELL (ROW_KEY,COLUMN_NAME,CELL_VALUE) values ('142','Objetivo',null);
...
Insert into HR.GAM_CELL (ROW_KEY,COLUMN_NAME,CELL_VALUE) values ('143','Fecha',null);
Insert into HR.GAM_CELL (ROW_KEY,COLUMN_NAME,CELL_VALUE) values ('143','Lugar',null);
Insert into HR.GAM_CELL (ROW_KEY,COLUMN_NAME,CELL_VALUE) values ('143','Nombre',null);
Insert into HR.GAM_CELL (ROW_KEY,COLUMN_NAME,CELL_VALUE) values ('143','Objetivo',null);
...
Insert into HR.GAM_COLUMNS (COLUMN_NAME,TABLE_NAME) values ('xxxx','xxx');
Insert into HR.GAM_COLUMNS (COLUMN_NAME,TABLE_NAME) values ('yyy','xxx');
REM INSERTING into HR.GAM_HISTORY
SET DEFINE OFF;
Insert into HR.GAM_HISTORY (ID_HISTORY,USER_ID,OPERATION,HISTORY_TS,TABLE_NAME,COLUMN_NAME,REWARDED) values ('101','david_castro','INSERT',to_timestamp('21/06/17 17:54:04,000000000','DD/MM/RR HH24:MI:SSXFF'),'Festividades',null,'S');
Insert into HR.GAM_HISTORY (ID_HISTORY,USER_ID,OPERATION,HISTORY_TS,TABLE_NAME,COLUMN_NAME,REWARDED) values ('102','david_castro','INSERT',to_timestamp('21/06/17 17:54:12,000000000','DD/MM/RR HH24:MI:SSXFF'),'Festividades',null,'S');
Insert into HR.GAM_HISTORY (ID_HISTORY,USER_ID,OPERATION,HISTORY_TS,TABLE_NAME,COLUMN_NAME,REWARDED) values ('103','david_castro','INSERT',to_timestamp('21/06/17 17:54:18,000000000','DD/MM/RR HH24:MI:SSXFF'),'Festividades',null,'S');
Insert into HR.GAM_HISTORY (ID_HISTORY,USER_ID,OPERATION,HISTORY_TS,TABLE_NAME,COLUMN_NAME,REWARDED) values ('104','david_castro','INSERT',to_timestamp('21/06/17 17:54:24,000000000','DD/MM/RR HH24:MI:SSXFF'),'Festividades',null,'S');
Insert into HR.GAM_HISTORY (ID_HISTORY,USER_ID,OPERATION,HISTORY_TS,TABLE_NAME,COLUMN_NAME,REWARDED) values ('105','david_castro','INSERT',to_timestamp('21/06/17 17:54:29,000000000','DD/MM/RR HH24:MI:SSXFF'),'Festividades',null,'S');
Insert into HR.GAM_HISTORY (ID_HISTORY,USER_ID,OPERATION,HISTORY_TS,TABLE_NAME,COLUMN_NAME,REWARDED) values ('124','test','INSERT',to_timestamp('05/07/17 17:31:41,000000000','DD/MM/RR HH24:MI:SSXFF'),'SUELDO',null,'S');
Insert into HR.GAM_HISTORY (ID_HISTORY,USER_ID,OPERATION,HISTORY_TS,TABLE_NAME,COLUMN_NAME,REWARDED) values ('125','test','INSERT',to_timestamp('05/07/17 17:31:51,000000000','DD/MM/RR HH24:MI:SSXFF'),'SUELDO',null,'S');
Insert into HR.GAM_HISTORY (ID_HISTORY,USER_ID,OPERATION,HISTORY_TS,TABLE_NAME,COLUMN_NAME,REWARDED) values ('126','test','INSERT',to_timestamp('05/07/17 17:31:55,000000000','DD/MM/RR HH24:MI:SSXFF'),'SUELDO',null,'S');
Insert into HR.GAM_HISTORY (ID_HISTORY,USER_ID,OPERATION,HISTORY_TS,TABLE_NAME,COLUMN_NAME,REWARDED) values ('127','test','DELETE',to_timestamp('05/07/17 17:32:29,000000000','DD/MM/RR HH24:MI:SSXFF'),'SUELDO',null,'S');
Insert into HR.GAM_HISTORY (ID_HISTORY,USER_ID,OPERATION,HISTORY_TS,TABLE_NAME,COLUMN_NAME,REWARDED) values ('128','test','DELETE',to_timestamp('05/07/17 17:32:32,000000000','DD/MM/RR HH24:MI:SSXFF'),'SUELDO',null,'S');
Insert into HR.GAM_HISTORY (ID_HISTORY,USER_ID,OPERATION,HISTORY_TS,TABLE_NAME,COLUMN_NAME,REWARDED) values ('129','test','DELETE',to_timestamp('05/07/17 17:32:34,000000000','DD/MM/RR HH24:MI:SSXFF'),'SUELDO',null,'S');
Insert into HR.GAM_HISTORY (ID_HISTORY,USER_ID,OPERATION,HISTORY_TS,TABLE_NAME,COLUMN_NAME,REWARDED) values ('130','test','INSERT',to_timestamp('05/07/17 17:33:44,000000000','DD/MM/RR HH24:MI:SSXFF'),'SUELDO',null,'S');
Insert into HR.GAM_HISTORY (ID_HISTORY,USER_ID,OPERATION,HISTORY_TS,TABLE_NAME,COLUMN_NAME,REWARDED) values ('70','admin','INSERT',to_timestamp('23/04/17 11:56:37,000000000','DD/MM/RR HH24:MI:SSXFF'),'Proveedores',null,'N');
...
Insert into HR.GAM_HISTORY (ID_HISTORY,USER_ID,OPERATION,HISTORY_TS,TABLE_NAME,COLUMN_NAME,REWARDED) values ('61','admin','DELETE',to_timestamp('23/04/17 11:10:41,000000000','DD/MM/RR HH24:MI:SSXFF'),'Festividades',null,'N');
Insert into HR.GAM_HISTORY (ID_HISTORY,USER_ID,OPERATION,HISTORY_TS,TABLE_NAME,COLUMN_NAME,REWARDED) values ('62','admin','DELETE',to_timestamp('23/04/17 11:12:01,000000000','DD/MM/RR HH24:MI:SSXFF'),'Festividades',null,'N');
Insert into HR.GAM_HISTORY (ID_HISTORY,USER_ID,OPERATION,HISTORY_TS,TABLE_NAME,COLUMN_NAME,REWARDED) values ('63','admin','DELETE',to_timestamp('23/04/17 11:12:14,000000000','DD/MM/RR HH24:MI:SSXFF'),'Festividades',null,'N');
Insert into HR.GAM_HISTORY (ID_HISTORY,USER_ID,OPERATION,HISTORY_TS,TABLE_NAME,COLUMN_NAME,REWARDED) values ('64','admin','DELETE',to_timestamp('23/04/17 11:13:04,000000000','DD/MM/RR HH24:MI:SSXFF'),'Festividades',null,'N');
Insert into HR.GAM_HISTORY (ID_HISTORY,USER_ID,OPERATION,HISTORY_TS,TABLE_NAME,COLUMN_NAME,REWARDED) values ('65','admin','DELETE',to_timestamp('23/04/17 11:13:34,000000000','DD/MM/RR HH24:MI:SSXFF'),'Festividades',null,'N');
Insert into HR.GAM_HISTORY (ID_HISTORY,USER_ID,OPERATION,HISTORY_TS,TABLE_NAME,COLUMN_NAME,REWARDED) values ('66','admin','DELETE',to_timestamp('23/04/17 11:13:56,000000000','DD/MM/RR HH24:MI:SSXFF'),'Festividades',null,'N');
Insert into HR.GAM_HISTORY (ID_HISTORY,USER_ID,OPERATION,HISTORY_TS,TABLE_NAME,COLUMN_NAME,REWARDED) values ('67','admin','DELETE',to_timestamp('23/04/17 11:13:59,000000000','DD/MM/RR HH24:MI:SSXFF'),'Festividades',null,'N');
Insert into HR.GAM_HISTORY (ID_HISTORY,USER_ID,OPERATION,HISTORY_TS,TABLE_NAME,COLUMN_NAME,REWARDED) values ('68','admin','DELETE',to_timestamp('23/04/17 11:14:03,000000000','DD/MM/RR HH24:MI:SSXFF'),'Festividades',null,'N');
Insert into HR.GAM_HISTORY (ID_HISTORY,USER_ID,OPERATION,HISTORY_TS,TABLE_NAME,COLUMN_NAME,REWARDED) values ('69','admin','DELETE',to_timestamp('23/04/17 11:14:06,000000000','DD/MM/RR HH24:MI:SSXFF'),'Festividades',null,'N');
Insert into HR.GAM_HISTORY (ID_HISTORY,USER_ID,OPERATION,HISTORY_TS,TABLE_NAME,COLUMN_NAME,REWARDED) values ('121','david_castro','INSERT',to_timestamp('05/07/17 17:02:55,000000000','DD/MM/RR HH24:MI:SSXFF'),'Festividades',null,'S');
Insert into HR.GAM_HISTORY (ID_HISTORY,USER_ID,OPERATION,HISTORY_TS,TABLE_NAME,COLUMN_NAME,REWARDED) values ('122','david_castro','INSERT',to_timestamp('05/07/17 17:03:26,000000000','DD/MM/RR HH24:MI:SSXFF'),'Festividades',null,'S');
Insert into HR.GAM_HISTORY (ID_HISTORY,USER_ID,OPERATION,HISTORY_TS,TABLE_NAME,COLUMN_NAME,REWARDED) values ('131','test','DELETE',to_timestamp('05/07/17 17:35:27,000000000','DD/MM/RR HH24:MI:SSXFF'),'SUELDO',null,'S');
Insert into HR.GAM_HISTORY (ID_HISTORY,USER_ID,OPERATION,HISTORY_TS,TABLE_NAME,COLUMN_NAME,REWARDED) values ('132','test','INSERT',to_timestamp('05/07/17 17:35:32,000000000','DD/MM/RR HH24:MI:SSXFF'),'SUELDO',null,'S');
Insert into HR.GAM_HISTORY (ID_HISTORY,USER_ID,OPERATION,HISTORY_TS,TABLE_NAME,COLUMN_NAME,REWARDED) values ('133','test','INSERT',to_timestamp('05/07/17 17:35:37,000000000','DD/MM/RR HH24:MI:SSXFF'),'SUELDO',null,'S');
Insert into HR.GAM_HISTORY (ID_HISTORY,USER_ID,OPERATION,HISTORY_TS,TABLE_NAME,COLUMN_NAME,REWARDED) values ('134','test','DELETE',to_timestamp('05/07/17 17:35:42,000000000','DD/MM/RR HH24:MI:SSXFF'),'SUELDO',null,'S');
Insert into HR.GAM_HISTORY (ID_HISTORY,USER_ID,OPERATION,HISTORY_TS,TABLE_NAME,COLUMN_NAME,REWARDED) values ('135','test','DELETE',to_timestamp('05/07/17 17:35:44,000000000','DD/MM/RR HH24:MI:SSXFF'),'SUELDO',null,'S');
Insert into HR.GAM_HISTORY (ID_HISTORY,USER_ID,OPERATION,HISTORY_TS,TABLE_NAME,COLUMN_NAME,REWARDED) values ('136','test','INSERT',to_timestamp('05/07/17 17:37:39,000000000','DD/MM/RR HH24:MI:SSXFF'),'SUELDO',null,'S');
Insert into HR.GAM_HISTORY (ID_HISTORY,USER_ID,OPERATION,HISTORY_TS,TABLE_NAME,COLUMN_NAME,REWARDED) values ('137','test','INSERT',to_timestamp('05/07/17 17:37:43,000000000','DD/MM/RR HH24:MI:SSXFF'),'SUELDO',null,'S');
Insert into HR.GAM_HISTORY (ID_HISTORY,USER_ID,OPERATION,HISTORY_TS,TABLE_NAME,COLUMN_NAME,REWARDED) values ('138','test','INSERT',to_timestamp('05/07/17 17:37:46,000000000','DD/MM/RR HH24:MI:SSXFF'),'SUELDO',null,'S');
Insert into HR.GAM_HISTORY (ID_HISTORY,USER_ID,OPERATION,HISTORY_TS,TABLE_NAME,COLUMN_NAME,REWARDED) values ('139','test','DELETE',to_timestamp('05/07/17 17:38:30,000000000','DD/MM/RR HH24:MI:SSXFF'),'SUELDO',null,'S');
Insert into HR.GAM_HISTORY (ID_HISTORY,USER_ID,OPERATION,HISTORY_TS,TABLE_NAME,COLUMN_NAME,REWARDED) values ('140','test','DELETE',to_timestamp('05/07/17 17:38:33,000000000','DD/MM/RR HH24:MI:SSXFF'),'SUELDO',null,'S');
Insert into HR.GAM_HISTORY (ID_HISTORY,USER_ID,OPERATION,HISTORY_TS,TABLE_NAME,COLUMN_NAME,REWARDED) values ('141','test','DELETE',to_timestamp('05/07/17 17:38:36,000000000','DD/MM/RR HH24:MI:SSXFF'),'SUELDO',null,'S');
...
Insert into HR.GAM_HISTORY (ID_HISTORY,USER_ID,OPERATION,HISTORY_TS,TABLE_NAME,COLUMN_NAME,REWARDED) values ('123','david_castro','INSERT',to_timestamp('05/07/17 17:12:03,000000000','DD/MM/RR HH24:MI:SSXFF'),'Festividades',null,'S');
Insert into HR.GAM_HISTORY (ID_HISTORY,USER_ID,OPERATION,HISTORY_TS,TABLE_NAME,COLUMN_NAME,REWARDED) values ('81','david_castro','UPDATE',to_timestamp('17/06/17 10:36:47,000000000','DD/MM/RR HH24:MI:SSXFF'),'Festividades','Nombre','N');
REM INSERTING into HR.GAM_LOG
SET DEFINE OFF;
Insert into HR.GAM_LOG (MSG_TEXT,LOG_TS) values ('V_REWARDS_TO_INSERT1',to_timestamp('21/06/17 17:54:04,000000000','DD/MM/RR HH24:MI:SSXFF'));
Insert into HR.GAM_LOG (MSG_TEXT,LOG_TS) values ('counter1',to_timestamp('21/06/17 17:54:04,000000000','DD/MM/RR HH24:MI:SSXFF'));
Insert into HR.GAM_LOG (MSG_TEXT,LOG_TS) values ('V_REWARDS_TO_INSERT1',to_timestamp('21/06/17 17:54:12,000000000','DD/MM/RR HH24:MI:SSXFF'));
Insert into HR.GAM_LOG (MSG_TEXT,LOG_TS) values ('counter1',to_timestamp('21/06/17 17:54:12,000000000','DD/MM/RR HH24:MI:SSXFF'));
Insert into HR.GAM_LOG (MSG_TEXT,LOG_TS) values ('V_REWARDS_TO_INSERT1',to_timestamp('21/06/17 17:54:18,000000000','DD/MM/RR HH24:MI:SSXFF'));
Insert into HR.GAM_LOG (MSG_TEXT,LOG_TS) values ('counter1',to_timestamp('21/06/17 17:54:18,000000000','DD/MM/RR HH24:MI:SSXFF'));
Insert into HR.GAM_LOG (MSG_TEXT,LOG_TS) values ('V_REWARDS_TO_INSERT1',to_timestamp('21/06/17 17:54:24,000000000','DD/MM/RR HH24:MI:SSXFF'));
Insert into HR.GAM_LOG (MSG_TEXT,LOG_TS) values ('counter1',to_timestamp('21/06/17 17:54:24,000000000','DD/MM/RR HH24:MI:SSXFF'));
Insert into HR.GAM_LOG (MSG_TEXT,LOG_TS) values ('V_REWARDS_TO_INSERT1',to_timestamp('21/06/17 17:54:29,000000000','DD/MM/RR HH24:MI:SSXFF'));
Insert into HR.GAM_LOG (MSG_TEXT,LOG_TS) values ('counter1',to_timestamp('21/06/17 17:54:29,000000000','DD/MM/RR HH24:MI:SSXFF'));
Insert into HR.GAM_LOG (MSG_TEXT,LOG_TS) values ('V_REWARDS_TO_INSERT1',to_timestamp('05/07/17 17:31:55,000000000','DD/MM/RR HH24:MI:SSXFF'));
Insert into HR.GAM_LOG (MSG_TEXT,LOG_TS) values ('counter1',to_timestamp('05/07/17 17:31:55,000000000','DD/MM/RR HH24:MI:SSXFF'));
Insert into HR.GAM_LOG (MSG_TEXT,LOG_TS) values ('V_REWARDS_TO_INSERT1',to_timestamp('05/07/17 17:32:34,000000000','DD/MM/RR HH24:MI:SSXFF'));
Insert into HR.GAM_LOG (MSG_TEXT,LOG_TS) values ('counter1',to_timestamp('05/07/17 17:32:34,000000000','DD/MM/RR HH24:MI:SSXFF'));
...
Insert into HR.GAM_LOG (MSG_TEXT,LOG_TS) values ('V_REWARDS_TO_INSERT1',to_timestamp('05/07/17 17:02:55,000000000','DD/MM/RR HH24:MI:SSXFF'));
Insert into HR.GAM_LOG (MSG_TEXT,LOG_TS) values ('counter1',to_timestamp('05/07/17 17:02:55,000000000','DD/MM/RR HH24:MI:SSXFF'));
Insert into HR.GAM_LOG (MSG_TEXT,LOG_TS) values ('V_REWARDS_TO_INSERT1',to_timestamp('05/07/17 17:03:26,000000000','DD/MM/RR HH24:MI:SSXFF'));
Insert into HR.GAM_LOG (MSG_TEXT,LOG_TS) values ('counter1',to_timestamp('05/07/17 17:03:26,000000000','DD/MM/RR HH24:MI:SSXFF'));
Insert into HR.GAM_LOG (MSG_TEXT,LOG_TS) values ('V_REWARDS_TO_INSERT1',to_timestamp('05/07/17 17:12:03,000000000','DD/MM/RR HH24:MI:SSXFF'));
Insert into HR.GAM_LOG (MSG_TEXT,LOG_TS) values ('counter1',to_timestamp('05/07/17 17:12:03,000000000','DD/MM/RR HH24:MI:SSXFF'));
Insert into HR.GAM_LOG (MSG_TEXT,LOG_TS) values ('V_REWARDS_TO_INSERT1',to_timestamp('05/07/17 17:35:37,000000000','DD/MM/RR HH24:MI:SSXFF'));
Insert into HR.GAM_LOG (MSG_TEXT,LOG_TS) values ('counter1',to_timestamp('05/07/17 17:35:37,000000000','DD/MM/RR HH24:MI:SSXFF'));
Insert into HR.GAM_LOG (MSG_TEXT,LOG_TS) values ('V_REWARDS_TO_INSERT1',to_timestamp('05/07/17 17:35:44,000000000','DD/MM/RR HH24:MI:SSXFF'));
Insert into HR.GAM_LOG (MSG_TEXT,LOG_TS) values ('counter1',to_timestamp('05/07/17 17:35:44,000000000','DD/MM/RR HH24:MI:SSXFF'));
Insert into HR.GAM_LOG (MSG_TEXT,LOG_TS) values ('V_REWARDS_TO_INSERT1',to_timestamp('05/07/17 17:37:46,000000000','DD/MM/RR HH24:MI:SSXFF'));
Insert into HR.GAM_LOG (MSG_TEXT,LOG_TS) values ('counter1',to_timestamp('05/07/17 17:37:46,000000000','DD/MM/RR HH24:MI:SSXFF'));
Insert into HR.GAM_LOG (MSG_TEXT,LOG_TS) values ('V_REWARDS_TO_INSERT1',to_timestamp('05/07/17 17:38:36,000000000','DD/MM/RR HH24:MI:SSXFF'));
Insert into HR.GAM_LOG (MSG_TEXT,LOG_TS) values ('counter1',to_timestamp('05/07/17 17:38:36,000000000','DD/MM/RR HH24:MI:SSXFF'));
REM INSERTING into HR.GAM_REWARD
SET DEFINE OFF;
Insert into HR.GAM_REWARD (ID_REWARD,REWARD_NAME,DESCRIPTION,IMAGE,QUANTIFIABLE,WEIGHT) values ('22','3 borrados','3 borrados!','http://findicons.com/files/icons/1588/farm_fresh_web/16/medal_gold_2.png','N','1');
Insert into HR.GAM_REWARD (ID_REWARD,REWARD_NAME,DESCRIPTION,IMAGE,QUANTIFIABLE,WEIGHT) values ('23','3 inserts','3 inserts!','http://findicons.com/files/icons/1588/farm_fresh_web/16/medal_gold_2.png','N','1');
Insert into HR.GAM_REWARD (ID_REWARD,REWARD_NAME,DESCRIPTION,IMAGE,QUANTIFIABLE,WEIGHT) values ('6','Recompensa prueba','Esta es la descripción de la recompensa de prueba','http://findicons.com/files/icons/1588/farm_fresh_web/16/medal_gold_2.png','Y','7');
Insert into HR.GAM_REWARD (ID_REWARD,REWARD_NAME,DESCRIPTION,IMAGE,QUANTIFIABLE,WEIGHT) values ('8','recompensa 2',null,'http://findicons.com/files/icons/1620/crystal_project/16/knewstuff.png','N','2');
REM INSERTING into HR.GAM_REWARDS_STATS
SET DEFINE OFF;
Insert into HR.GAM_REWARDS_STATS (ID_REWARDS_STATS,USER_ID,STATS_TS,ID_STRATEGY,ID_ACTION,SHOWN) values ('41','david_castro',to_timestamp('21/06/17 17:54:04,000000000','DD/MM/RR HH24:MI:SSXFF'),'3','21','Y');
Insert into HR.GAM_REWARDS_STATS (ID_REWARDS_STATS,USER_ID,STATS_TS,ID_STRATEGY,ID_ACTION,SHOWN) values ('42','david_castro',to_timestamp('21/06/17 17:54:12,000000000','DD/MM/RR HH24:MI:SSXFF'),'3','21','Y');
Insert into HR.GAM_REWARDS_STATS (ID_REWARDS_STATS,USER_ID,STATS_TS,ID_STRATEGY,ID_ACTION,SHOWN) values ('43','david_castro',to_timestamp('21/06/17 17:54:18,000000000','DD/MM/RR HH24:MI:SSXFF'),'3','21','Y');
Insert into HR.GAM_REWARDS_STATS (ID_REWARDS_STATS,USER_ID,STATS_TS,ID_STRATEGY,ID_ACTION,SHOWN) values ('44','david_castro',to_timestamp('21/06/17 17:54:24,000000000','DD/MM/RR HH24:MI:SSXFF'),'3','21','Y');
Insert into HR.GAM_REWARDS_STATS (ID_REWARDS_STATS,USER_ID,STATS_TS,ID_STRATEGY,ID_ACTION,SHOWN) values ('45','david_castro',to_timestamp('21/06/17 17:54:29,000000000','DD/MM/RR HH24:MI:SSXFF'),'3','21','Y');
Insert into HR.GAM_REWARDS_STATS (ID_REWARDS_STATS,USER_ID,STATS_TS,ID_STRATEGY,ID_ACTION,SHOWN) values ('64','test',to_timestamp('05/07/17 17:31:55,000000000','DD/MM/RR HH24:MI:SSXFF'),'2','47','Y');
Insert into HR.GAM_REWARDS_STATS (ID_REWARDS_STATS,USER_ID,STATS_TS,ID_STRATEGY,ID_ACTION,SHOWN) values ('65','test',to_timestamp('05/07/17 17:32:34,000000000','DD/MM/RR HH24:MI:SSXFF'),'2','46','Y');
Insert into HR.GAM_REWARDS_STATS (ID_REWARDS_STATS,USER_ID,STATS_TS,ID_STRATEGY,ID_ACTION,SHOWN) values ('1','david_castro',to_timestamp('22/04/17 12:19:44,000000000','DD/MM/RR HH24:MI:SSXFF'),'3','21','Y');
Insert into HR.GAM_REWARDS_STATS (ID_REWARDS_STATS,USER_ID,STATS_TS,ID_STRATEGY,ID_ACTION,SHOWN) values ('2','david_castro',to_timestamp('22/04/17 12:19:44,000000000','DD/MM/RR HH24:MI:SSXFF'),'3','21','Y');
Insert into HR.GAM_REWARDS_STATS (ID_REWARDS_STATS,USER_ID,STATS_TS,ID_STRATEGY,ID_ACTION,SHOWN) values ('3','david_castro',to_timestamp('22/04/17 12:19:44,000000000','DD/MM/RR HH24:MI:SSXFF'),'3','21','Y');
Insert into HR.GAM_REWARDS_STATS (ID_REWARDS_STATS,USER_ID,STATS_TS,ID_STRATEGY,ID_ACTION,SHOWN) values ('4','david_castro',to_timestamp('22/04/17 12:19:44,000000000','DD/MM/RR HH24:MI:SSXFF'),'3','21','Y');
Insert into HR.GAM_REWARDS_STATS (ID_REWARDS_STATS,USER_ID,STATS_TS,ID_STRATEGY,ID_ACTION,SHOWN) values ('5','david_castro',to_timestamp('22/04/17 12:19:44,000000000','DD/MM/RR HH24:MI:SSXFF'),'3','21','Y');
Insert into HR.GAM_REWARDS_STATS (ID_REWARDS_STATS,USER_ID,STATS_TS,ID_STRATEGY,ID_ACTION,SHOWN) values ('6','david_castro',to_timestamp('22/04/17 12:19:44,000000000','DD/MM/RR HH24:MI:SSXFF'),'3','21','Y');
Insert into HR.GAM_REWARDS_STATS (ID_REWARDS_STATS,USER_ID,STATS_TS,ID_STRATEGY,ID_ACTION,SHOWN) values ('7','david_castro',to_timestamp('22/04/17 12:19:44,000000000','DD/MM/RR HH24:MI:SSXFF'),'3','21','Y');
Insert into HR.GAM_REWARDS_STATS (ID_REWARDS_STATS,USER_ID,STATS_TS,ID_STRATEGY,ID_ACTION,SHOWN) values ('8','david_castro',to_timestamp('22/04/17 12:19:44,000000000','DD/MM/RR HH24:MI:SSXFF'),'3','21','Y');
Insert into HR.GAM_REWARDS_STATS (ID_REWARDS_STATS,USER_ID,STATS_TS,ID_STRATEGY,ID_ACTION,SHOWN) values ('9','david_castro',to_timestamp('22/04/17 12:19:44,000000000','DD/MM/RR HH24:MI:SSXFF'),'3','21','Y');
Insert into HR.GAM_REWARDS_STATS (ID_REWARDS_STATS,USER_ID,STATS_TS,ID_STRATEGY,ID_ACTION,SHOWN) values ('10','david_castro',to_timestamp('22/04/17 12:19:44,000000000','DD/MM/RR HH24:MI:SSXFF'),'3','21','Y');
Insert into HR.GAM_REWARDS_STATS (ID_REWARDS_STATS,USER_ID,STATS_TS,ID_STRATEGY,ID_ACTION,SHOWN) values ('11','david_castro',to_timestamp('22/04/17 12:19:44,000000000','DD/MM/RR HH24:MI:SSXFF'),'3','21','Y');
Insert into HR.GAM_REWARDS_STATS (ID_REWARDS_STATS,USER_ID,STATS_TS,ID_STRATEGY,ID_ACTION,SHOWN) values ('12','david_castro',to_timestamp('22/04/17 12:19:44,000000000','DD/MM/RR HH24:MI:SSXFF'),'3','21','Y');
Insert into HR.GAM_REWARDS_STATS (ID_REWARDS_STATS,USER_ID,STATS_TS,ID_STRATEGY,ID_ACTION,SHOWN) values ('13','david_castro',to_timestamp('22/04/17 12:19:44,000000000','DD/MM/RR HH24:MI:SSXFF'),'3','21','Y');
Insert into HR.GAM_REWARDS_STATS (ID_REWARDS_STATS,USER_ID,STATS_TS,ID_STRATEGY,ID_ACTION,SHOWN) values ('14','david_castro',to_timestamp('22/04/17 12:19:44,000000000','DD/MM/RR HH24:MI:SSXFF'),'3','21','Y');
Insert into HR.GAM_REWARDS_STATS (ID_REWARDS_STATS,USER_ID,STATS_TS,ID_STRATEGY,ID_ACTION,SHOWN) values ('15','david_castro',to_timestamp('22/04/17 12:19:44,000000000','DD/MM/RR HH24:MI:SSXFF'),'3','21','Y');
Insert into HR.GAM_REWARDS_STATS (ID_REWARDS_STATS,USER_ID,STATS_TS,ID_STRATEGY,ID_ACTION,SHOWN) values ('16','david_castro',to_timestamp('22/04/17 12:19:44,000000000','DD/MM/RR HH24:MI:SSXFF'),'3','21','Y');
Insert into HR.GAM_REWARDS_STATS (ID_REWARDS_STATS,USER_ID,STATS_TS,ID_STRATEGY,ID_ACTION,SHOWN) values ('17','david_castro',to_timestamp('22/04/17 12:19:44,000000000','DD/MM/RR HH24:MI:SSXFF'),'3','21','Y');
Insert into HR.GAM_REWARDS_STATS (ID_REWARDS_STATS,USER_ID,STATS_TS,ID_STRATEGY,ID_ACTION,SHOWN) values ('18','david_castro',to_timestamp('22/04/17 12:19:44,000000000','DD/MM/RR HH24:MI:SSXFF'),'3','3','Y');
Insert into HR.GAM_REWARDS_STATS (ID_REWARDS_STATS,USER_ID,STATS_TS,ID_STRATEGY,ID_ACTION,SHOWN) values ('19','david_castro',to_timestamp('22/04/17 12:19:44,000000000','DD/MM/RR HH24:MI:SSXFF'),'3','3','Y');
Insert into HR.GAM_REWARDS_STATS (ID_REWARDS_STATS,USER_ID,STATS_TS,ID_STRATEGY,ID_ACTION,SHOWN) values ('20','david_castro',to_timestamp('22/04/17 12:19:44,000000000','DD/MM/RR HH24:MI:SSXFF'),'3','3','Y');
Insert into HR.GAM_REWARDS_STATS (ID_REWARDS_STATS,USER_ID,STATS_TS,ID_STRATEGY,ID_ACTION,SHOWN) values ('21','david_castro',to_timestamp('22/04/17 12:44:35,000000000','DD/MM/RR HH24:MI:SSXFF'),'3','21','Y');
Insert into HR.GAM_REWARDS_STATS (ID_REWARDS_STATS,USER_ID,STATS_TS,ID_STRATEGY,ID_ACTION,SHOWN) values ('22','david_castro',to_timestamp('22/04/17 12:49:58,000000000','DD/MM/RR HH24:MI:SSXFF'),'3','21','Y');
Insert into HR.GAM_REWARDS_STATS (ID_REWARDS_STATS,USER_ID,STATS_TS,ID_STRATEGY,ID_ACTION,SHOWN) values ('23','david_castro',to_timestamp('22/04/17 12:49:58,000000000','DD/MM/RR HH24:MI:SSXFF'),'3','21','Y');
Insert into HR.GAM_REWARDS_STATS (ID_REWARDS_STATS,USER_ID,STATS_TS,ID_STRATEGY,ID_ACTION,SHOWN) values ('24','david_castro',to_timestamp('22/04/17 12:59:07,000000000','DD/MM/RR HH24:MI:SSXFF'),'3','21','Y');
Insert into HR.GAM_REWARDS_STATS (ID_REWARDS_STATS,USER_ID,STATS_TS,ID_STRATEGY,ID_ACTION,SHOWN) values ('25','david_castro',to_timestamp('22/04/17 12:59:07,000000000','DD/MM/RR HH24:MI:SSXFF'),'3','21','Y');
Insert into HR.GAM_REWARDS_STATS (ID_REWARDS_STATS,USER_ID,STATS_TS,ID_STRATEGY,ID_ACTION,SHOWN) values ('26','david_castro',to_timestamp('22/04/17 12:59:32,000000000','DD/MM/RR HH24:MI:SSXFF'),'3','21','Y');
Insert into HR.GAM_REWARDS_STATS (ID_REWARDS_STATS,USER_ID,STATS_TS,ID_STRATEGY,ID_ACTION,SHOWN) values ('61','david_castro',to_timestamp('05/07/17 17:02:55,000000000','DD/MM/RR HH24:MI:SSXFF'),'3','21','Y');
Insert into HR.GAM_REWARDS_STATS (ID_REWARDS_STATS,USER_ID,STATS_TS,ID_STRATEGY,ID_ACTION,SHOWN) values ('62','david_castro',to_timestamp('05/07/17 17:03:26,000000000','DD/MM/RR HH24:MI:SSXFF'),'3','21','Y');
Insert into HR.GAM_REWARDS_STATS (ID_REWARDS_STATS,USER_ID,STATS_TS,ID_STRATEGY,ID_ACTION,SHOWN) values ('66','test',to_timestamp('05/07/17 17:35:37,000000000','DD/MM/RR HH24:MI:SSXFF'),'2','47','Y');
Insert into HR.GAM_REWARDS_STATS (ID_REWARDS_STATS,USER_ID,STATS_TS,ID_STRATEGY,ID_ACTION,SHOWN) values ('67','test',to_timestamp('05/07/17 17:35:44,000000000','DD/MM/RR HH24:MI:SSXFF'),'2','46','Y');
Insert into HR.GAM_REWARDS_STATS (ID_REWARDS_STATS,USER_ID,STATS_TS,ID_STRATEGY,ID_ACTION,SHOWN) values ('68','test',to_timestamp('05/07/17 17:37:46,000000000','DD/MM/RR HH24:MI:SSXFF'),'2','47','Y');
Insert into HR.GAM_REWARDS_STATS (ID_REWARDS_STATS,USER_ID,STATS_TS,ID_STRATEGY,ID_ACTION,SHOWN) values ('69','test',to_timestamp('05/07/17 17:38:36,000000000','DD/MM/RR HH24:MI:SSXFF'),'2','46','Y');
Insert into HR.GAM_REWARDS_STATS (ID_REWARDS_STATS,USER_ID,STATS_TS,ID_STRATEGY,ID_ACTION,SHOWN) values ('63','david_castro',to_timestamp('05/07/17 17:12:03,000000000','DD/MM/RR HH24:MI:SSXFF'),'3','21','Y');
...
SET DEFINE OFF;
Insert into HR.GAM_ROWS (ROW_KEY,TABLE_NAME) values ('121','Festividades');
Insert into HR.GAM_ROWS (ROW_KEY,TABLE_NAME) values ('7','EMPLEADO');
Insert into HR.GAM_ROWS (ROW_KEY,TABLE_NAME) values ('122','Festividades');
Insert into HR.GAM_ROWS (ROW_KEY,TABLE_NAME) values ('123','Festividades');
Insert into HR.GAM_ROWS (ROW_KEY,TABLE_NAME) values ('124','Festividades');
Insert into HR.GAM_ROWS (ROW_KEY,TABLE_NAME) values ('125','Festividades');
Insert into HR.GAM_ROWS (ROW_KEY,TABLE_NAME) values ('101','Proveedores');
Insert into HR.GAM_ROWS (ROW_KEY,TABLE_NAME) values ('44','Festividades');
Insert into HR.GAM_ROWS (ROW_KEY,TABLE_NAME) values ('141','Festividades');
Insert into HR.GAM_ROWS (ROW_KEY,TABLE_NAME) values ('142','Festividades');
...
Insert into HR.GAM_ROWS (ROW_KEY,TABLE_NAME) values ('143','Festividades');
...
Insert into HR.GAM_SCHEMAS (SCHEMA_NAME) values ('prueba CU');
...
Insert into HR.GAM_TABLES (TABLE_NAME,SCHEMA) values ('dfdfdf','prueba CU');
Insert into HR.GAM_TABLES (TABLE_NAME,SCHEMA) values ('tabla1','Test demo');
Insert into HR.GAM_TABLES (TABLE_NAME,SCHEMA) values ('nueva','prueba CU');
Insert into HR.GAM_TABLES (TABLE_NAME,SCHEMA) values ('xxx','prueba CU');
...
Insert into HR.GAM_USER_ROLE (USER_ID,ROLE_NAME) values ('admin','ROL_AYUNTAMIENTO');
Insert into HR.GAM_USER_ROLE (USER_ID,ROLE_NAME) values ('david_castro','ROL_AYUNTAMIENTO');
Insert into HR.GAM_USER_ROLE (USER_ID,ROLE_NAME) values ('test','ROL_AYUNTAMIENTO');
...
SET DEFINE OFF;
Insert into HR.GAM_USERS (USER_ID,PASS,NAME,LASTNAME) values ('test','test','test','test');
...
--------------------------------------------------------
  ...
  ALTER TABLE "HR"."GAM_REWARDS_STATS" MODIFY ("SHOWN" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "HR"."GAM_ACTIONS" ADD CONSTRAINT "GAM_ACTIONS_FK4" FOREIGN KEY ("ID_REWARD")
	  REFERENCES "HR"."GAM_REWARD" ("ID_REWARD") ENABLE;
--------------------------------------------------------
